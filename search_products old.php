...
<?php
	...
	$query_sp='select * from product where pname like "'.$str.'" ORDER BY prating DESC LIMIT '.($page*$size).', '.$size.'';
...
<?php
$query_total='select count(pid) from product where pname like "'.$str.'"';
