...
{
echo '
<h4 style="margin-left:8%;margin-top:10px;">Please, Login to access this feature.</h4>
<script>
				...
				<div class="panel panel-login">
                    ...
                    <?php
						...
						if(isset($_COOKIE["semail"]))
							$cookie=$_COOKIE["semail"];
					?>
					<div class="panel-body"> 
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="seller_signin_process.php" onSubmit="return login()" method="post" role="form" style="display: block;">
									<div class="form-group">
										<input type="text" name="email_log" id="email_log" tabindex="1" class="form-control" placeholder="Email" value="<?php echo $cookie;?>">
									</div>
									<div class="form-group">
								...
								<form id="register-form" action="seller_signup_process.php" onSubmit="return signup()" method="post" role="form" style="display:none;" enctype="multipart/form-data">
									<div class="form-group">
										<input type="text" name="username" id="username" tabindex="1" class="form-control" placeholder="Shop Name">
									</div>
									<div class="form-group">
										<input type="text" name="email" id="email" tabindex="1" class="form-control" placeholder="Email">
									</div>
                                    <div class="form-group">
										<input type="text" name="mobile" id="mobile" tabindex="1" class="form-control" placeholder="Mobile">
									</div>
                                    ...
                                    <div class="form-group">
										<input type="text" name="address" id="address" tabindex="1" class="form-control" placeholder="Shop Address">
									</div>
                                    <div class="form-group">
										<input type="text" name="pincode" id="pincode" tabindex="1" class="form-control" placeholder="Pincode">
									</div>

                                    <div class="form-group">
										<input type="file" class="filestyle" id="profile_seller" name="profile_seller" data-classButton="btn btn-primary" data-input="false" data-buttonText="Choose shop profile picture." accept="image/*">
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
