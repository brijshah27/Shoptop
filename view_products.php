<head>
    ...
    <title>SHOPTOP- View Products</title>
    ...
    <link href="css/view_products.css" rel="stylesheet" type="text/css">
...
$query_pro='select * from product natural join category where sid="'.$_SESSION["seller_id"].'" LIMIT '.($page*$size).', '.$size.'';
$result_pro = mysqli_query($con,$query_pro);
if(mysqli_num_rows($result_pro)==0)
{
	echo'<div class="container" style="margin-bottom:380px;">
<div class="col-lg-11">
...
if($row_pro["capprove"]==0)
$pr='style="box-shadow:0px 0px 5px #F00;"';
else
$pr='';
	$rate=0;
	...
	<a href="single_product.php?pid='.$row_pro["pid"].'">
		<div class="product" '.$pr.'>
			...
			<div class="proEdit">
				<a href="edit_product.php?pid='.$row_pro["pid"].'" class="btn btn-primary" id="editBtn">Edit Product</a>
				<a href="del_product.php?pid='.$row_pro["pid"].'" class="btn btn-primary" id="delBtn">Delete Product</a>
			</div>
		</div>
	</a>';
}
...
$query_total='select count(pid) from product where sid='.$_SESSION["seller_id"].'';
$result_total = mysqli_query($con,$query_total);
$row_total= mysqli_fetch_array($result_total);
$last=floor($row_total["count(pid)"]/($size+1));
if($page!=0)
{
	echo '<a href="view_products.php?page='.($page-1).'"><div class="prev"> <u><b>&lt; Previous</b></u></div></a>';
	echo '<a href="view_products.php?page=0"><div class="home"> <u><b>&lt; HOME &gt;</b></u></div></a>';
}
if($page!=$last)
	echo '<a href="view_products.php?page='.($page+1).'"><div class="next"> <u><b>Next &gt;</b></u></div></a>';
