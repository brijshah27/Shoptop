...
?>
    ...
    <form id="user_profile_edit-form" action="edit_user_profile_process.php" method="post" role="form" onSubmit="return editPro()" style="float:left; width:100%; margin-top:100px;" enctype="multipart/form-data">

    <div style="float:left;">
    <div id="prodiv">
    <img id="proimg" src="<?php echo $profileImg;?>" alt="Profile">
    <input type="file" name="profile_user" id="proinput" onChange="Profile(event)" accept="image/*">
    </div>
    ...
    <div style="float:left; margin-left:3%; width:40%;">
      ...
      <input type="text" name="username" id="username" tabindex="1" class="form-control" placeholder="Name" value="<?php echo $row_seller["uname"];?>">
      </div>
      <div class="form-group">
        <input type="text" name="mobile" id="mobile" tabindex="1" class="form-control" placeholder="Mobile" value="<?php echo $row_seller["umobile"];?>">
      </div>
      ...
      <div class="form-group">
      <input type="text" name="address" id="address" tabindex="1" class="form-control" placeholder="Address" value="<?php echo $row_seller["uaddress"];?>">
      </div>
      <div class="form-group">
      <input type="text" name="pincode" id="pincode" tabindex="1" class="form-control" placeholder="Pin Code" value="<?php echo $row_seller["upincode"];?>">
      </div>
      <div class="form-group">
...
<div style="margin-top:40%"><?php include ("footer.php") ?></div>
